...
def projectguide(request):
    return HttpResponse(serializers.serialize("json", ProjectGuide.objects.raw('SELECT * FROM portal_projectguide join portal_project on portal_projectguide.project = portal_project.id')))
